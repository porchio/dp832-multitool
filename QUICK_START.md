...
| Profile | Description | Voltage | Chemistry |
|---------|-------------|---------|-----------|
| `lifepo4.json` | LiFePO4 single cell | 3.2V | LiFePO4 |
| `lifepo4_3s.json` | LiFePO4 3S pack | 9.6V | LiFePO4 |
| `liion_18650.json` | 18650 Li-ion cell | 3.7V | Li-ion |
| `lipo_1s.json` | 1S LiPo battery | 3.7V | LiPo |
| `lead_acid_6v.json` | Lead-acid battery | 6V | Lead-acid |
| `nimh_aa.json` | NiMH AA cell | 1.2V | NiMH |
...
- **Development History**: See `DEVELOPMENT_SUMMARY.md`
- **Feature Checklist**: See `PROJECT_STATUS.md`
- **Profile Details**: See `profiles/README.md`
- **Config Examples**: See `examples/README.md`
...
**For detailed information, see the comprehensive documentation in `README.md`**
